...
<body>
  <div class="container">
    <div class="card">
      <form action="page/produk-furniture/simpan.php" method="post" enctype="multipart/form-data" id="formSimpan">
        <h2 class="form-title">Tambah Produk Furniture</h2>

        <div class="form-grid">
          <label for="nama_furniture" class="form-label">Nama Furniture</label>
          <input type="text" id="nama_furniture" name="nama_furniture" class="form-input" required />
        </div>
