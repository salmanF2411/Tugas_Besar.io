...
<body>
  <div class="container">
    <div class="card">
      <form action="page/produk-baju/simpan.php" method="post" enctype="multipart/form-data" id="formSimpan">
        <h2 class="form-title">Tambah Produk Baju</h2>

        <div class="form-grid">
          <label for="nama_baju" class="form-label">Nama Baju</label>
          <input type="text" id="nama_baju" name="nama_baju" class="form-input" required />
        </div>
