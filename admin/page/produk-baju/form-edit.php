...
<body>
  <div class="container">
    <div class="card">
      <form action="page/produk-baju/edit.php" method="post" enctype="multipart/form-data" id="furnitureForm">
        <h2 class="form-title">Edit Produk Baju</h2>
        ...
        <div class="form-grid">
          ...
          <input type="text" id="nama" name="nama_baju" class="form-input" value="<?= $data['nama_baju']; ?>" required />
        </div>
  ...
  <script>
    ...
    document.getElementById('furnitureForm').addEventListener('submit', function() {
      setTimeout(function() {
        window.location.href = '../../dashboard.php?module=produk-baju&page=baju';
      }, 100);
    });
  </script>
</body>
