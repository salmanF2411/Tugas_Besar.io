...
<body>
  <div class="container">
    <div class="card">
      <form action="page/metode-pengiriman/edit.php" method="post" enctype="multipart/form-data" id="furnitureForm">
        <h2 class="form-title">Edit Metode pengiriman</h2>
        ...
        <div class="form-grid">
          ...
          <input type="text" id="nama" name="nama_pengiriman" class="form-input" value="<?= $data['nama_pengiriman']; ?>" required />
        </div>
  ...
  <script>
    ...
    document.getElementById('furnitureForm').addEventListener('submit', function() {
      setTimeout(function() {
        window.location.href = '../../dashboard.php?module=metode-pengiriman&page=daftar-mpengiriman';
      }, 100);
    });
  </script>
</body>
