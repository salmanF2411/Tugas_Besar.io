...
<body>
  <div class="container">
    <div class="card">
      <form action="page/metode-pengiriman/simpan.php" method="post" enctype="multipart/form-data" id="formSimpan">
        <h2 class="form-title">Tambah Metode pengiriman</h2>

        <div class="form-grid">
          <label for="nama_pengiriman" class="form-label">Nama pengiriman</label>
          <input type="text" id="nama_pengiriman" name="nama_pengiriman" class="form-input" required />
        </div>
