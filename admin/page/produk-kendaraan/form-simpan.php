...
<body>
  <div class="container">
    <div class="card">
      <form action="page/produk-kendaraan/simpan.php" method="post" enctype="multipart/form-data" id="formSimpan">
        <h2 class="form-title">Tambah Produk kendaraan</h2>

        <div class="form-grid">
          <label for="nama_kendaraan" class="form-label">Nama kendaraan</label>
          <input type="text" id="nama_kendaraan" name="nama_kendaraan" class="form-input" required />
        </div>
