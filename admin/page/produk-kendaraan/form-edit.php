...
<body>
  <div class="container">
    <div class="card">
      <form action="page/produk-kendaraan/edit.php" method="post" enctype="multipart/form-data" id="furnitureForm">
        <h2 class="form-title">Edit Produk kendaraan</h2>
        ...
        <div class="form-grid">
          ...
          <input type="text" id="nama" name="nama_kendaraan" class="form-input" value="<?= $data['nama_kendaraan']; ?>" required />
        </div>
  ...
  <script>
    ...
    document.getElementById('furnitureForm').addEventListener('submit', function() {
      setTimeout(function() {
        window.location.href = '../../dashboard.php?module=produk-kendaraan&page=kendaraan';
      }, 100);
    });
  </script>
</body>
