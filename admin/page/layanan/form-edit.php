...
<body>
  <div class="container">
    <div class="card">
      <form action="page/layanan/edit.php" method="post" enctype="multipart/form-data" id="furnitureForm">
        ...
        <div class="form-grid">
          ...
          <input type="text" id="nama" name="nama_layanan" class="form-input" value="<?= $data['nama_layanan']; ?>" required />
        </div>
  ...
  <script>
    ...
    document.getElementById('furnitureForm').addEventListener('submit', function() {
      setTimeout(function() {
        window.location.href = '../../dashboard.php?module=layanan&page=daftar-layanan';
      }, 100);
    });
  </script>
</body>
