...
<body>
  <div class="container">
    <div class="card">
      <form action="page/produk-buku/simpan.php" method="post" enctype="multipart/form-data" id="formSimpan">
        <h2 class="form-title">Tambah Produk Buku</h2>

        <div class="form-grid">
          <label for="nama_buku" class="form-label">Nama buku</label>
          <input type="text" id="nama_buku" name="nama_buku" class="form-input" required />
        </div>
