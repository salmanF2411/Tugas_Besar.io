...
<body>
  <div class="container">
    <div class="card">
      <form action="page/reward/simpan.php" method="post" enctype="multipart/form-data" id="formSimpan">
        <h2 class="form-title">Tambah reward</h2>

        <div class="form-grid">
          <label for="nama_reward" class="form-label">Nama reward</label>
          <input type="text" id="nama_reward" name="nama_reward" class="form-input" required />
        </div>
