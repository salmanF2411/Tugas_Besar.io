...
<body>
  <div class="container">
    <div class="card">
      <form action="page/produk-rak/simpan.php" method="post" enctype="multipart/form-data" id="formSimpan">
        <h2 class="form-title">Tambah Produk Rak</h2>

        <div class="form-grid">
          <label for="nama_rak" class="form-label">Nama Rak</label>
          <input type="text" id="nama_rak" name="nama_rak" class="form-input" required />
        </div>
