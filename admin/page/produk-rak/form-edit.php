...
<body>
  <div class="container">
    <div class="card">
      <form action="page/produk-rak/edit.php" method="post" enctype="multipart/form-data" id="furnitureForm">
        <h2 class="form-title">Edit Produk rak</h2>
        ...
        <div class="form-grid">
          ...
          <input type="text" id="nama" name="nama_rak" class="form-input" value="<?= $data['nama_rak']; ?>" required />
        </div>
  ...
  <script>
    ...
    document.getElementById('furnitureForm').addEventListener('submit', function() {
      setTimeout(function() {
        window.location.href = '../../dashboard.php?module=produk-rak&page=rak-penyimpanan';
      }, 100);
    });
  </script>
</body>
