...
<body>
  <div class="container">
    <div class="card">
      <form action="page/partners/simpan.php" method="post" enctype="multipart/form-data" id="formSimpan">
        <h2 class="form-title">Tambah Produk partner</h2>

        <div class="form-grid">
          <label for="nama_partner" class="form-label">Nama partner</label>
          <input type="text" id="nama_partner" name="nama_partner" class="form-input" required />
        </div>
