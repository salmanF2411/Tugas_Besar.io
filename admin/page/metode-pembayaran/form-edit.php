...
<body>
  <div class="container">
    <div class="card">
      <form action="page/metode-pembayaran/edit.php" method="post" enctype="multipart/form-data" id="furnitureForm">
        <h2 class="form-title">Edit Metode pembayaran</h2>
        ...
        <div class="form-grid">
          ...
          <input type="text" id="nama" name="nama_pembayaran" class="form-input" value="<?= $data['nama_pembayaran']; ?>" required />
        </div>
  ...
  <script>
    ...
    document.getElementById('furnitureForm').addEventListener('submit', function() {
      setTimeout(function() {
        window.location.href = '../../dashboard.php?module=metode-pembayaran&page=daftar-mpembayaran';
      }, 100);
    });
  </script>
</body>
