...
<body>
  <div class="container">
    <div class="card">
      <form action="page/produk-elektronik/simpan.php" method="post" enctype="multipart/form-data" id="formSimpan">
        <h2 class="form-title">Tambah Produk Elektronik</h2>

        <div class="form-grid">
          <label for="nama_elektronik" class="form-label">Nama Elektronik</label>
          <input type="text" id="nama_elektronik" name="nama_elektronik" class="form-input" required />
        </div>
