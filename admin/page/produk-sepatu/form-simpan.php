...
<body>
  <div class="container">
    <div class="card">
      <form action="page/produk-sepatu/simpan.php" method="post" enctype="multipart/form-data" id="formSimpan">
        <h2 class="form-title">Tambah Produk Furniture</h2>

        <div class="form-grid">
          <label for="nama_furniture" class="form-label">Nama Furniture</label>
          <input type="text" id="nama_sepatu" name="nama_sepatu" class="form-input" required />
        </div>
