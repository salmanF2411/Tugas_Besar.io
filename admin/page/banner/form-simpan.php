...
<body>
  <div class="container">
    <div class="card">
      <form action="page/banner/simpan.php" method="post" enctype="multipart/form-data" id="formSimpan">
        <h2 class="form-title">Tambah Banner</h2>

        <div class="form-grid">
          <label for="nama_banner" class="form-label">Nama Banner</label>
          <input type="text" id="nama_banner" name="nama_banner" class="form-input" required />
        </div>
