...
<body>
  <div class="container">
    <div class="card">
      <form action="page/banner/edit.php" method="post" enctype="multipart/form-data" id="furnitureForm">
        ...
        <div class="form-grid">
          <label for="nama" class="form-label">Nama Banner</label>
          <input type="text" id="nama" name="nama_banner" class="form-input" value="<?= $data['nama_banner']; ?>" required />
        </div>
  ...
  <script>
    ...
    document.getElementById('furnitureForm').addEventListener('submit', function() {
      setTimeout(function() {
        window.location.href = '../../dashboard.php?module=banner&page=daftar-banner';
      }, 100);
    });
  </script>
</body>
