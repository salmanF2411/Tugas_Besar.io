...
$row = $furniture->get_by_id($_GET['id']);
...
<body>
  <div class="container">
    <div class="img-container">
      <img class="img-detail" src="img/<?= htmlspecialchars($row['cover']) ?>" alt="<?= htmlspecialchars($row['nama_furniture']) ?>">
    </div>
    <div class="info-container">
      <div>
        <h1><?= htmlspecialchars($row['nama_furniture']) ?></h1>
      ...
      <div class="actions">
        <a href="<?= 'index.php?module=produk&page=furniture' ?>" class="btn btn-back">← Kembali</a>
