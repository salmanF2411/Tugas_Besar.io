...
<body>
  <div class="container">
    <div class="img-container">
      <img class="img-detail" src="img/<?= htmlspecialchars($row['cover']) ?>" alt="<?= htmlspecialchars($row['nama_baju']) ?>">
    </div>
    <div class="info-container">
      <div>
        <h1><?= htmlspecialchars($row['nama_baju']) ?></h1>
      ...
      <div class="actions">
        <a href="<?= 'index.php?module=produk&page=baju' ?>" class="btn btn-back">← Kembali</a>
