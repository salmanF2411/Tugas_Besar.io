...
$row = $kendaraan->get_by_id($_GET['id']);
...
<body>
  <div class="container">
    <div class="img-container">
      <img class="img-detail" src="img/<?= htmlspecialchars($row['cover']) ?>" alt="<?= htmlspecialchars($row['nama_kendaraan']) ?>">
    </div>
    <div class="info-container">
      <div>
        <h1><?= htmlspecialchars($row['nama_kendaraan']) ?></h1>
      ...
      <div class="actions">
        <a href="<?= 'index.php?module=produk&page=kendaraan' ?>" class="btn btn-back">← Kembali</a>
