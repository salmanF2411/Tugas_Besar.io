...
<body>
  <div class="container">
    <div class="img-container">
      <img class="img-detail" src="img/<?= htmlspecialchars($row['cover']) ?>" alt="<?= htmlspecialchars($row['nama_sepatu']) ?>">
    </div>
    <div class="info-container">
      <div>
        <h1><?= htmlspecialchars($row['nama_sepatu']) ?></h1>
      ...
      <div class="actions">
        <a href="<?= 'index.php?module=produk&page=sepatu' ?>" class="btn btn-back">← Kembali</a>
