...
<body>
  <div class="container">
    <div class="img-container">
      <img class="img-detail" src="img/<?= htmlspecialchars($row['cover']) ?>" alt="<?= htmlspecialchars($row['nama_rak']) ?>">
    </div>
    <div class="info-container">
      <div>
        <h1><?= htmlspecialchars($row['nama_rak']) ?></h1>
      ...
      <div class="actions">
        <a href="<?= 'index.php?module=produk&page=rak-penyimpanan' ?>" class="btn btn-back">← Kembali</a>
