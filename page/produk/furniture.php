...
<body>
  ...
  <div class="container">
    <?php foreach ($furnitures as $row): ?>
      <a href="index.php?module=detail&page=detail-furniture&id=<?= $row['id_furniture'] ?>" class="card-link">
        <div class="card">
          <img src="img/<?= "$row[cover] " ?>" alt="<?= htmlspecialchars($row['nama_furniture']) ?>">
          <div class="card-content">
            <div class="product-name"><?= htmlspecialchars($row['nama_furniture']) ?></div>
