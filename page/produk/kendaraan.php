...
<body>
  ...
  <div class="container">
    <?php foreach ($kendaraans as $row): ?>
      <a href="index.php?module=detail&page=detail-kendaraan&id=<?= $row['id_kendaraan'] ?>" class="card-link">
        <div class="card">
          <img src="img/<?= htmlspecialchars($row['cover']) ?>" alt="<?= htmlspecialchars($row['nama_kendaraan']) ?>">
          <div class="card-content">
            <div class="product-name"><?= htmlspecialchars($row['nama_kendaraan']) ?></div>
