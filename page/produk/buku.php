...
<body>
  ...
  <div class="container">
    <?php foreach ($bukus as $row): ?>
      <a href="index.php?module=detail&page=detail-buku&id=<?= $row['id_buku'] ?>" class="card-link">
        <div class="card">
          <img src="img/<?= "$row[cover] " ?>" alt="<?= htmlspecialchars($row['nama_buku']) ?>">
          <div class="card-content">
            <div class="product-name"><?= htmlspecialchars($row['nama_buku']) ?></div>
