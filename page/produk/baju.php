...
<body>
  ...
  <div class="container">
    <?php foreach ($bajus as $row): ?>
      <a href="index.php?module=detail&page=detail-baju&id=<?= $row['id_baju'] ?>" class="card-link">
        <div class="card">
          <img src="img/<?= "$row[cover] " ?>" alt="<?= htmlspecialchars($row['nama_baju']) ?>">
          <div class="card-content">
            <div class="product-name"><?= htmlspecialchars($row['nama_baju']) ?></div>
