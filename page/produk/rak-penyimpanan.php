...
<body>
  ...
  <div class="container">
    <?php foreach ($raks as $row): ?>
      <a href="index.php?module=detail&page=detail-rak&id=<?= $row['id_rak'] ?>" class="card-link">
        <div class="card">
          <img src="img/<?= "$row[cover] " ?>" alt="<?= htmlspecialchars($row['nama_rak']) ?>">
          <div class="card-content">
            <div class="product-name"><?= htmlspecialchars($row['nama_rak']) ?></div>
